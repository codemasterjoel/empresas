 <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    <div class="container-fluid py-4">
      ...
      <div class="row mt-4">
        <div class="col-lg-12 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <h5 class=" font-bold">MAPA DE RECICLADORAS</h5>
              <div class="row">
                <div class="ms-auto text-center mt-5 mt-lg-0">
                  <div class=" border-radius-lg h-100">
  ...
  <script>
    function initMap() 
    {
        ...
        {
            zoom: 12,
            center:new google.maps.LatLng(10.4775571,-66.9210107),
        });
            ...
            const contentString{{ $empresa->codigo }} =
                '<div id="content" style="color:black; text-align:left;">' +
                  '<div id="bodyContent">'+
                    ...
                    "</div>" +
                "</div>";
                const infowindow{{$empresa->codigo}} = new google.maps.InfoWindow({
                content: contentString{{$empresa->codigo}},
                });    

            marker{{$empresa->codigo}} = new google.maps.Marker({
                map: map,
                animation: google.maps.Animation.DROP,
                position: new google.maps.LatLng({{$empresa->lat}},{{$empresa->lon}}),
                title: '{{ $empresa->nombre }}',
            });

            marker{{$empresa->codigo}}.addListener("click", () => {
                infowindow{{$empresa->codigo}}.open({
                    anchor: marker{{$empresa->codigo}},
                    map,
                    shouldFocus: false,
                });
            });
