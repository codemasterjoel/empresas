            ...
            <div class="row">
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-2">
                        <div class="card-header text-center align-middle pb-0 bg-transparent mx-auto mt-8">
                            <img src="{{asset('img/logoccs.png')}}" class="navbar-brand-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                        <div class=" bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('{{asset('img/fondo2.jpg')}}')"></div>
                    </div>
                </div>
            </div>
        </div>
