                                ...
                                <div class="flex items-center justify-center"> {{-- campo cedula --}}
                                    <div class="w-full rounded-lg">
                                        <div class="flex">
                                            <!-- component -->
                                            <label>
                                                <input type="radio" value="1" {{isset($conformidad) ? 'checked' : ''}} class="peer hidden"  name="conformidad" wire:model.live="posee_conformidad">
                                                <div class="hover:bg-blue-500 flex items-center justify-between px-4 py-2 border-2 rounded-lg cursor-pointer text-sm  border-gray-200 group peer-checked:border-blue-700  peer-checked:bg-blue-400">
                                                    <h2 class="font-medium text-gray-700">SI</h2>
                                                </div>
                                            </label>
                                            ...
                                            <label>
                                                <input type="radio" value="0" {{isset($conformidad) ? 'checked' : ''}} class="peer hidden" name="conformidad" wire:model.live="posee_conformidad">
                                                <div class="hover:bg-red-500 flex items-center justify-between px-4 py-2 border-2 rounded-lg cursor-pointer text-sm  border-gray-200 group peer-checked:border-red-500 peer-checked:text-white peer-checked:bg-red-400">
                                                    <h2 class="font-medium text-gray-700">NO</h2>
                                                </div>
                                            </label>
                                ...
                                <div class="flex items-center justify-center"> {{-- campo cedula --}}
                                    <div class="w-full rounded-lg">
                                        <div class="flex">
                                            <!-- component -->
                                            <label>
                                                <input type="radio" value="1" {{isset($runpa) ? 'checked' : ''}} class="peer hidden"  name="framework" wire:model.live="posee_runpa">
                                                <div class="hover:bg-blue-500 flex items-center justify-between px-4 py-2 border-2 rounded-lg cursor-pointer text-sm  border-gray-200 group peer-checked:border-blue-700  peer-checked:bg-blue-400">
                                                    <h2 class="font-medium text-gray-700">SI</h2>
                                                </div>
                                            </label>
                                            ...
                                            <label>
                                                <input type="radio" value="0" {{isset($runpa) ? 'checked' : ''}} class="peer hidden" name="framework" wire:model.live="posee_runpa">
                                                <div class="hover:bg-red-500 flex items-center justify-between px-4 py-2 border-2 rounded-lg cursor-pointer text-sm  border-gray-200 group peer-checked:border-red-500 peer-checked:text-white peer-checked:bg-red-400">
                                                    <h2 class="font-medium text-gray-700">NO</h2>
                                                </div>
                                            </label>
