...
<body>
    <table style="width: 100%; border: 0px;">
		<tr class="mb-4"><td><img style="width:80%" src="img/alcaldia.png"></td><td style="text-align: right;"><img style="width:50%; display:block; margin-left:auto;" src="img/fecea.png"></td></tr>
        <tr><td style="text-align: left; width: 33%"></td><td style="text-align: right; width: 64%">Nº de Registro: FECEA-{{$empresa->codigo}}/{{$empresa->created_at->format('Y')}}</td></tr>
    </table>
			...
			<tr>
				<td style="text-align:justify">
					<ul>
						...
						<ol>2.	<b>CUMPLIMIENTO NORMATIVO DE TRANSPORTE:</b>Las unidades de transporte empleadas para la actividad deben cumplir con la Ley de Transporte Terrestre, su Reglamento, y las Normas COVENIN vigentes. Queda prohibido el uso de vehículos de carga de gran envergadura (gandolas) que dificulten la movilidad urbana en las zonas residenciales autorizadas.</ol>
