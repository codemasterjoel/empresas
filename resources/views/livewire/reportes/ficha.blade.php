...
<body>
    <table style="width: 100%; border: 0px;">
        <tr><td style="text-align: left; width: 33%"></td><td style="text-align: right; width: 64%">Receptoría Nº R-1088</td></tr>
		<tr style="margin-top: -40px;"><td style="text-align: left; width: 33%; margin-top: -20px;">Ciudadano(a):</td><td style="text-align: right; width: 100%">SECA DCU-00-0000-0</td></tr>
		<tr><td style="text-align: left; width: 100%">{{$empresa->nombres}} {{$empresa->apellidos}}</td></tr>
        ...
        <tbody>
			...
			<tr>
				<td style="text-align:justify; text-indent: 2em;">
					En atención a la receptoría Nº R-1088 de fecha {{$empresa->created_at}}, mediante la cual solicita inscripción en el Registro de Empresas Recicladoras , Recuperadoras o afines del manejo de materiales susceptibles al reciclaje,(materiales no peligrosos), la empresa <b>{{$empresa->nombre}}</b> ,ubicada en <b>{{$empresa->direccion}}</b>; cumplo en participarle que de acuerdo al informe de inspección realizado por personal técnico adscrito a este despacho, y visto los recaudos que acompañan la solicitud; esta Dirección de conformidad con lo establecido en el Artículo 178 de la Constitución de la República Bolivariana de Venezuela;  Artículo 56 literal “d” de la Ley Orgánica del Poder Público Municipal; Artículo 14 numerales 1 y 2 y Artículo 68 de la Ley de Residuos y Desechos Sólidos y la Ordenanza para la Gestión y Tratamiento Integral de los Residuos y Desechos Sólidos en Jurisdicción Territorial del Municipio Bolivariano Libertador (publicada en la Gaceta Municipal del Municipio Bolivariano Libertador Nº 4742-2 de fecha 25/10/2021), le participa que la empresa <b>{{$empresa->nombre}}</b> Rif. <b>{{$empresa->tipoRIF}}{{$empresa->rif}}</b>, queda registrada bajo el número DCU-00-0000-0 de fecha <b>{{$empresa->created_at}}</b>, para realizar ACOPIO, COMPRA, VENTA Y COMERCIALIZACIÓN DE MATERIALES SUSCEPTIBLES AL RECICLAJE, debiendo dar cumplimiento a las siguientes condiciones:
				</td>
			</tr>
			<tr>
            ...
            <tr>
                ...
                <img src="data:image/png;base64, {!! base64_encode(QrCode::format('svg')->size(150)->generate('https://intranet.sistemadeformacionfranciscodemiranda.org.ve/info/')) !!} "></td>
            </tr>
		</tbody>
	</table>
</body>
